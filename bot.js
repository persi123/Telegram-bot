...
bot.start((msg) => {
    ...
    msg.reply(chatId, "Hi ! This is a  vaccine bot 18+ for  alwar. It will alert you when 18+ vaccine is available in your area. Thanks Prashant");
    //debug error
    ...
    const temprature=()=>{
        ...
        if(!error && response.statusCode==200){
            ...
            const dat=res.centers.map(data=>{if(data.sessions[0].min_age_limit == 18 ){
                  data.sessions[0].available_capacity != 0?msg.reply(chatId,data.address):null
